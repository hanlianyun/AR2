...
ARjs.MarkerControls.prototype._initArtoolkit = function(){
	...
	function onMarkerFound(event){
		...
		if (_this.parameters.patternUrl == '../examples/marker-training/examples/pattern-files/pattern-more.patt') {
			//viewsuc = 1
			check(1);
		}
		if (_this.parameters.patternUrl == '../examples/marker-training/examples/pattern-files/pattern-hiro.patt') {
			//viewsuc = 0
			check(2);
		}
